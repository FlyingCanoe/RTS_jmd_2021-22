...
class Controleur:
    def __init__(self):
        ...
        self.urlserveur = "http://127.0.0.1:7999"
    ...
    def creerpartie(self, nom, urljeu, valciv):
        self.civilisation = valciv
        print("Ma civ: ", self.civilisation)
    ...
    def inscrirejoueur(self, nom, urljeu, valciv):
        self.civilisation = valciv
        print("iNSCRIT", self.civilisation)
        if self.prochainsplash:
            self.vue.root.after_cancel(self.prochainsplash)
            self.prochainsplash = None
        if nom:
    ...
    def abandonner(self):
        ...
        self.vue.root.after(1500, self.vue.root.destroy)
